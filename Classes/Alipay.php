...
class Alipay
{
    ...
    private $is_mobile = FALSE; // 验证码图片实例
    
    private $service = 'create_direct_pay_by_user';
    private $service_wap = 'alipay.wap.trade.create.direct';

    private $alipay_gateway = 'https://mapi.alipay.com/gateway.do?';
    private $alipay_gateway_mobile = 'http://wappaygw.alipay.com/service/rest.htm?';
    
    private $verify_url = 'http://notify.alipay.com/trade/notify_query.do?';
    private $verify_url_https = 'https://mapi.alipay.com/gateway.do?service=notify_verify&';
    /**
     * 架构方法 设置参数
     * @access public
    ...
    function prepareMobileTradeData($params)
    {
        ...
        $responseText = $this->getHttpResponsePOST($url, $this->config['cacert'],$request_data,$input_charset);
